...
public class Interpreter implements InterpreterVisitor {	
	...
	HashMap<String, StatementList> methodStatements = new HashMap<String, StatementList>();	
	...
	protected Symbol lookup(String id) {
	 ...
	 // MainClass m;
	  ...
	  public Object visit(MethodDecl n) {
	    ...
	    methodStatements.put(n.i.s, n.sl);
	  ...
	  public Object visit(Call n) {
		  ...
		  for (int i = 0; i < n.el.size(); i++) { //set input parameter values
			  ParameterSymbol ps = method.getParam(i);
			  ps.value = n.el.elementAt(i).accept(this);
		  }
		  
		  /*for (int i = 0; i < n.size(); i++) { //set variable values
			  VariableSymbol ps = method.getParam(i);
			  ps.value = n.el.elementAt(i).accept(this);
		  }*/
		  
		  for (int i = 0; i < method.el.size(); i++) {
			  returnValue = method.el.elementAt(i).accept(this);
		  }
