...
public class Main {
    public static void main(String [] args) {
		try {
			...
			File file = new File("C:\\tiger2\\testcases\\Factorial2.java"); //has duplicate var decl.
			...
			//SYNTAX COLOURING
		    SyntaxColouringVisitor scv = new SyntaxColouringVisitor();
		    root.accept(scv);
		    ...
		    if (tcv.error.anyErrors){
		    	System.out.println("Type-checking completed (with errors).");
		    }
		    else {
